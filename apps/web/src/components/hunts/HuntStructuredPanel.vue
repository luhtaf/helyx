...
// Mode 1 of HuntCreateView: structured (Actors × Assets) wizard.
// Extracted from the standalone HuntCreateView so all 3 modes
// (structured / ttp-seed / guess-actor) live under /hunts/new.
...
<template>
  <div>
    <nav class="mb-8 flex items-center gap-3 font-mono text-[11px]">
